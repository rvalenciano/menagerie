#!/bin/sh
# Fires sustained HTTP load at the rate limiter's demo server and prints
# a vegeta report (throughput, success ratio, latency percentiles).
#
...
RATE="${1:-200}"
DURATION="${2:-30s}"
TARGET="${3:-http://rate-limiter:3000/}"
